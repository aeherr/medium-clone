...
class FollowButton extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <div onClick={this.followUser} data-reactroot=""><button className={f === -1 ? "button green-border-button follow-button" : "button green-inner-button follow-button"}>{f === -1 ? 'Follow':'Following'}</button></div>
                </div>
            </div>
        );
    }
